...
var eachBlockSpan = allBlocks[0].querySelector(":scope > span");
var elemToClick = document.body;
simulate(elemToClick, "mousedown");
sleep(500);
var actElement = document.activeElement;
console.log(actElement);
elemToClick = eachBlockSpan;
...
var eachBlockSpan = allBlocks[1].querySelector(":scope > span");
var elemToClick = document.body;
console.log(elemToClick);
simulate(elemToClick, "mousedown");
simulate(elemToClick, "mouseup");
sleep(500);
var actElement = document.activeElement;
console.log(actElement);
elemToClick = eachBlockSpan;
...
for (var i = 0; i < allBlocks.length; i++)
{
    ...
    if(eachBlockSpan !== null)
    {
        ...
        //sleep(500);
        tempPrompt = Number(prompt('Continue', 0));
        //simulate(eachBlockSpan, "click");
        //simulate(eachBlockSpan, "mouseup");
